...
Project Operating System — permanent until the project owner adjusts it.

This protocol defines how Claude and Cursor must work together on every project.
...
* **Blocker** — Unsafe, broken, insecure, or cannot ship.
* **Major** — Works partially but has an important functional or UX problem.
* **Minor** — Works but needs a smaller correction.
